                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="personaldata" role="tabpanel" aria-labelledby="tab1">
                        <div class="form-group row">
                          <label for="inputSalutation" class="col-sm-3 col-form-label col-form-label-sm">Salutation</label>
                          <div class="col-sm-9">
                            <input type="text" name="salutation" class="form-control-plaintext form-control-sm" id="inputSalutation"  value="<?php if(isset($salutation)) echo $salutation['name']?>" readonly>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputFirstname" class="col-sm-3 col-form-label col-form-label-sm">Vorname</label>
                            <div class="col-sm-9">
                              <input type="text" name="firstname" class="form-control-plaintext form-control-sm" id="inputFirstname" placeholder="Vorname" value="<?php if(isset($firstname)) echo $firstname?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputLastname" class="col-sm-3 col-form-label col-form-label-sm">Nachname</label>
                            <div class="col-sm-9">
                              <input type="text" name="lastname" class="form-control-plaintext form-control-sm" id="inputLastname" placeholder="Nachname" value="<?php if(isset($lastname)) echo $lastname?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputEmail" class="col-sm-3 col-form-label col-form-label-sm">E-Mail</label>
                            <div class="col-sm-9">
                              <input type="email" name="email" class="form-control-plaintext form-control-sm" id="inputEmail" placeholder="E-Mail" value="<?php if(isset($email)) echo $email?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputNationality" class="col-sm-3 col-form-label col-form-label-sm">Nationalität</label>
                          <div class="col-sm-9">
                            <select id="inputNationality"  name="nationality" class="form-control form-control-sm" required>
						                	<?php 
                        ...
                        <div class="form-group row">
                          <label for="inputLastname" class="col-sm-3 col-form-label col-form-label-sm">Geburtsdatum</label>
                            <div class="col-sm-9">
                              <input type="date" pattern="\d{4}-\d{1,2}-\d{1,2}"  id = "inputBday" name="birthday" class="form-control form-control-sm" placeholder="YYYY-MM-DD" <?php if(isset($birthday)) echo "value=\"$birthday\""; ?>>
                    ...
                    <div class="tab-pane fade" id="homeaddress" role="tabpanel" aria-labelledby="tab2">
                        <div class="form-group row">
                          <label for="inputStreet" class="col-sm-3 col-form-label col-form-label-sm">Straße und Haus-Nr.</label>
                            <div class="col-sm-9">
                              <input type="text" maxlength="40" name="home_street" class="form-control form-control-sm" id="inputStreet" placeholder="street, house no" value="<?php if(isset($home_street)) echo $home_street?>" >
                        ...
                        <div class="form-group row">
                          <label for="inputZip" class="col-sm-3 col-form-label col-form-label-sm">PLZ</label>
                            <div class="col-sm-9">
                              <input type="text" maxlength="10" name="home_zip" class="form-control form-control-sm" id="inputZip" placeholder="postcode" value="<?php if(isset($home_zip)) echo $home_zip?>" >
                        ...
                        <div class="form-group row">
                          <label for="inputCity" class="col-sm-3 col-form-label col-form-label-sm">Ort</label>
                            <div class="col-sm-9">
                              <input type="text" maxlength="40" name="home_city" class="form-control form-control-sm" id="inputCity" placeholder="city" value="<?php if(isset($home_city)) echo $home_city?>" >
                        ...
                        <div class="form-group row">
                          <label for="inputState" class="col-sm-3 col-form-label col-form-label-sm">Bundesland</label>
                            <div class="col-sm-9">
                              <input type="text" maxlength="40" name="home_state" class="form-control form-control-sm" id="inputState" placeholder="state" value="<?php if(isset($home_state)) echo $home_state?>" >
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select id="inputCountry"  name="home_country" class="form-control form-control-sm" placeholder="country" required>
						                	<?php 
						                		$statement = $pdo->prepare("SELECT * FROM country ORDER BY country_id");
						                		$result = $statement->execute();
						                		while($row = $statement->fetch()) { ?>
                        ...
                        <div class="form-group row">
                          <label for="inputPhone" class="col-sm-3 col-form-label col-form-label-sm">Telefonnummer</label>
                            <div class="col-sm-9">
                              <input type="text" maxlength="15" name="home_phone" class="form-control form-control-sm" id="inputPhone" placeholder="phone number" value="<?php if(isset($home_phone)) echo $home_phone?>" >
                    ...
                    <div class="tab-pane fade" id="homestudy" role="tabpanel" aria-labelledby="tab3">
                      ...
                      <div class="form-group row"> 
				              	<label for="inputHomeUniversity" class="col-sm-3 col-form-label col-form-label-sm">Aktuelle Universität</label>
				              	<div class="col-sm-9">
				              		<select type="value" id="inputHomeUniversity"  name="home_university" class="form-control form-control-sm">
				              			<?php 
                      ...
                      <div class="form-group row"> 
				              	<label for="inputHomeDegree" class="col-sm-3 col-form-label col-form-label-sm">Derzeit angestrebter Abschluss</label>
				              	<div class="col-sm-9">
				              		<select type="value" id="inputHomeDegree"  name="home_degree" class="form-control form-control-sm">
				              			<?php 
                      ...
                      <div class="form-group row"> 
				              	<label for="inputHomeCourse" class="col-sm-3 col-form-label col-form-label-sm">Aktueller Studiengang</label>
				              	<div class="col-sm-9">
				              		<select type="value" id="inputHomeCourse"  name="home_course" class="form-control form-control-sm">
				              			<?php 
                      ...
                      <div class="form-group row">
                        <label for="inputMatrNo" class="col-sm-3 col-form-label col-form-label-sm">Matrikelnummer</label>
                          <div class="col-sm-9">
                            <input type="number" maxlength="10"  name="home_matno" class="form-control form-control-sm" id="inputMatrNo" placeholder="matriculation number" value="<?php if(isset($home_matno)) echo $home_matno?>" >
                            <div id="matnoFeedback" class="invalid-feedback"></div>    
                          </div>
                      </div>

                      <div class="form-group row"> 
				              	<label for="inputEnrollment" class="col-sm-3 col-form-label col-form-label-sm">Monat/Jahr der Einschreibung in aktuellen Studiengan</label>
				              	<div class="col-sm-9">
                    ...
                    <div class="alert alert-warning">
                      Wenn du deine hochgeladenen Dokumente nicht ändern möchten, kannst du diesen Abschnitt überspringen und deine Bewerbung jetzt speichern. Andernfalls werden vorhandene Dokumente durch neue Dokumente ersetzt.
