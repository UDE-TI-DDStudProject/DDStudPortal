    ...
    <div class="card setup-form">
        ...
        <nav class="nav-application-form">
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link active" id="tab1" data-toggle="tab" href="#personaldata" role="tab" aria-controls="personaldata" aria-selected="true">Persönliche Daten</a>
            <a class="nav-item nav-link" id="tab2" data-toggle="tab" href="#email" role="tab" aria-controls="email" aria-selected="false">E-Mail</a>
            <a class="nav-item nav-link" id="tab3" data-toggle="tab" href="#password" role="tab" aria-controls="password" aria-selected="false">Passwort</a>
            <a class="nav-item nav-link" id="tab4" data-toggle="tab" href="#deleteaccount" role="tab" aria-controls="deleteaccount" aria-selected="false">Account löschen</a>
          </div>
        </nav>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="personaldata" role="tabpanel" aria-labelledby="tab1">
                <!-- form -->
                <form id="personalForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="needs-validation" novalidate>
                    <div class="form-group row">
                      <label for="inputSalutation" class="col-sm-3 col-form-label col-form-label-sm">Salutation</label>
                      <div class="col-sm-9">
                        <select class="form-control form-control-sm" id="inputSalutation" name="salutation" placeholder="salutation" required>
                            <?php
							  $statement = $pdo->prepare("SELECT * FROM salutation");
							  $result = $statement->execute();
							  while($row = $statement->fetch()) { ?>
							  	<option value="<?php echo ($row['salutation_id'])?>" <?php if(isset($salutationid) and $salutationid == $row['salutation_id']) echo "selected"; ?>><?php echo ($row['name'])?></option>
							  <?php } ?>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputFirstname" class="col-sm-3 col-form-label col-form-label-sm">Vorname</label>
                        <div class="col-sm-9">
                          <input type="text" name="firstname" class="form-control form-control-sm" id="inputFirstname" placeholder="Vorname" value="<?php if(isset($firstname)) echo $firstname?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputLastname" class="col-sm-3 col-form-label col-form-label-sm">Nachname</label>
                        <div class="col-sm-9">
                          <input type="text" name="lastname" class="form-control form-control-sm" id="inputLastname" placeholder="Nachname" value="<?php if(isset($lastname)) echo $lastname?>" required>
                        </div>
                    </div>
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary" id="btnPersonal" name="btnPersonal">Speichern</button>
                    </div>
                </form>
            </div>
            ...
            <div class="tab-pane fade" id="email" role="tabpanel" aria-labelledby="tab2">
                <!-- form -->
                <form id="emailForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="needs-validation" novalidate>
                    <div class="form-group row">
                        <label for="inputEmail" class="col-sm-3 col-form-label col-form-label-sm">E-Mail</label>
                        <div class="col-sm-9">
                          <input type="email" name="emailCurr" class="form-control-plaintext form-control-sm" id="emailCurr"  value="<?php if(isset($email)) echo $email?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label for="inputEmailNew" class="col-sm-3 col-form-label col-form-label-sm">Neue E-Mail wiederholen</label>
                        <div class="col-sm-9">
                          <input type="email" name="emailNew1" class="form-control form-control-sm" id="inputEmailNew" >
                        </div>
                    </div>
                    <div class="text-right">
            ...
            <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="tab3">
                <!-- form -->
                <form id="passwordForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="needs-validation" novalidate>
                    <div class="form-group row">
                      <label for="inputPasswordOld" class="col-sm-3 col-form-label col-form-label-sm">Passwort</label>
                        <div class="col-sm-9">
                          <input type="password" name="passwordOld" class="form-control form-control-sm" id="inputPasswordOld" >
                        </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPasswordNew" class="col-sm-3 col-form-label col-form-label-sm">Neues Passwort</label>
                        <div class="col-sm-9">
                          <input type="password" name="passwordNew" class="form-control form-control-sm" id="inputPasswordNew" >
                        </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPasswordNew" class="col-sm-3 col-form-label col-form-label-sm">Neues Passwort wiederholen</label>
                        <div class="col-sm-9">
                          <input type="password" name="passwordNew1" class="form-control form-control-sm" id="inputPasswordNew" >
                        </div>
                    </div>
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary" id="btnPassword" name="btnPassword">Speichern</button>
                    </div>
                </form>
            </div>
            ...
            <div class="tab-pane fade" id="deleteaccount" role="tabpanel" aria-labelledby="tab4">
                ...
                <form id="deleteAccount" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="needs-validation" novalidate>
                    <div class="form-group row">
                      <label for="inputPassword" class="col-sm-3 col-form-label col-form-label-sm">Passwort</label>
                        <div class="col-sm-9">
                          <input type="password" name="password" class="form-control form-control-sm" id="inputPassword" >
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-danger" id="btnDelete" name="btnDelete">Account löschen</button>
                    </div>
                </form>
            </div>
        </div> 
